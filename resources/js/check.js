...
import Location from './components/LocationCheck.vue';
...
// 		useWorker: true
// 	});
// 	const colors = ['#FFD700', '#FFA500', '#C0C0C0', '#E8E8E8'];
// 	if ($(window).width() <= 500) {
// 		defaults = {
// 			angle: 90,
// 			spread: 180,
...
function launchGoldenWeek() {
	$("#gw").addClass("fired");
	setTimeout(function() {
		setTimeout(function() {
			$("#gw").removeClass("fired");
		}, 7500);
	}, 500);
}
...
ScrollTrigger.create({
	...
	onEnter: function() {
		if (!goldenWeekLoop) {
			launchGoldenWeek();
			goldenWeekLoop = setInterval(launchGoldenWeek, 10000);
		}
	}
});
...
const floorPlan1 = new Swiper('#menu .swiper', {
	...
	pagination: {
		...
		renderFraction: function (currentClass) {
			return '<div class="nav-box"><div class="top-box"><div class="line"></div><p>SLIDE</p></div><div class="bottom-box"><p class="current ' + currentClass + '">0</p><div class="connect-line"></div><p class="total">15</p></div></div>';
		},
