<template>
	<div ref="bottomBox" class="movie-content-box">
		...
		<div v-if="completed" class="bottom-box">
			<button v-if="currentVideo !== 'dinner-time202601'" class="next-btn" :class="{ 'four-links': currentVideo === 'new-year' }" @click="changeVideo" :data-src="'dinner-time202601'">
				<p><span>デ</span><span>ィ</span><span>ナ</span><span>ー</span><span>タ</span><span>イ</span><span>ム</span><span>特</span><span>別</span><span>営</span><span>業</span></p>
			</button>
...
<script setup>
	...
	const currentVideo = ref(props.initialQueryValue || 'dinner-time');
