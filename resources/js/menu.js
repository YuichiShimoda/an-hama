...
gsap.to("#indian", {
	scrollTrigger: {
		trigger: "#indian .base-box",
		start: "center bottom-=1%",
		onEnter: () => {
			$("#indian .top-content-box").addClass("is-show");
		},
	}
});
gsap.fromTo("#indian .base-box",
	{opacity: 0.0, y: "-30vh"},
	{opacity: 1.0, y: "0", ease: "power1.out",
		scrollTrigger: {
			trigger: "#indian",
...
gsap.to("#indian .right-box", {
	scrollTrigger: {
		trigger: "#indian .right-box",
		start: "top bottom-=1%",
		end: "top bottom-=1%",
		onEnter: () => {
			$("#indian .right-box").addClass("is-show");
		},
		onLeaveBack: () => {
			$("#indian .right-box").removeClass("is-show");
		}
	}
});
