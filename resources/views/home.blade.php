...
@section('css')
    ...
    <link href="{{ asset('/css/style-sp.css') }}?v=5" rel='stylesheet' type='text/css' media='all and (max-width: 700px)'>
    <link href="{{ asset('/css/style.css') }}?v=5" rel='stylesheet' type='text/css' media='all and (min-width: 700px)'>
@stop
