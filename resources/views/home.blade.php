...
<!--     <div id="gw" class="">
        <div class="content-box">
            ...
            <div class="catch-txt-box">
                <p>あんかけの常識、塗り替えます！</p>
                <p>GWに出会う、旨味凝縮ご褒美ランチ！</p>
            </div>
        </div>
    ...
    <div id="gw" class="">
        <div class="content-box">
            ...
            <div class="mid-box">
                ...
                <div class="lunch">
                    <img class="lazyload" src="{{ asset('image/gw/lunch.svg') }}" alt="ランチ">
                </div>
                <div class="sun">
                    <img class="lazyload" src="{{ asset('image/gw/sun.svg') }}" alt="太陽">
                </div>
                <div class="rainbow">
                    <img class="lazyload" src="{{ asset('image/gw/rainbow.svg') }}" alt="虹">
                </div>
                <div class="car">
