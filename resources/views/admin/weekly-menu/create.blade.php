...
@section('content')
    <form action="{{ route('admin.weekly-menu.store') }}" method="POST">
        ...
        {{-- メニュー --}}
        <div class="d-block">
            <x-adminlte-input name="menu" label="メニュー" placeholder="ハンバーグ" value="{{ old('menu') }}"/>
<!--             <div class="form-note-box">
        ...
        <div class="d-block period-box">
            <x-adminlte-input-date name="start_day" label="提供開始日" :config="['format' => 'YYYY-MM-DD']" value="{{ old('start_day') }}">
