...
@section('title', 'お知らせ ( NEWS ) 管理｜新規作成')
    ...
    <form action="{{ route('admin.news.store') }}" method="POST">
        ...
        <div class="d-block">
            <x-adminlte-select name="category" label="カテゴリ">
                ...
                <option value="新ｻｰﾋﾞｽ" {{ old('category') == '新ｻｰﾋﾞｽ' ? 'selected' : '' }}>新ｻｰﾋﾞｽ</option>
                <option value="新ﾒﾆｭｰ" {{ old('category') == '新ﾒﾆｭｰ' ? 'selected' : '' }}>新ﾒﾆｭｰ</option>
