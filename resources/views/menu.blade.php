...
@section('content')
    <section id="first-view">
        <h1>メニュー</h1>
        <div class="desc-box">
            <p class="base pc">“あんハマ”の<span class="red-line">あんかけパスタ</span>は、定番系と創作系</p>
            <p class="base sp">“あんハマ”の<span class="red-line">あんかけパスタ</span>は<br>定番系と創作系</p>
...
<!--     <section id="announcement">
    ...
    <section id="gallery">
        <div class="img-box">
            <img src="{{ asset('image/menu/disallow/scene1.webp') }}" alt="注文">
            <div class="overlay click-canvas"></div>
        </div>
        <div class="img-box">
            <img src="{{ asset('image/menu/disallow/scene2.webp') }}" alt="料理運び">
            <div class="overlay click-canvas"></div>
        </div>
