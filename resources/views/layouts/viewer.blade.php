...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	<head>
		...
		<style>
			@font-face {
				...
				src: url("{{ url('fonts/MinIWA-Lt-V3-Regular.woff2', [], true) }}") format('woff2');
				font-weight: 400;
				font-style: normal;
				font-display: swap;
			}
			@font-face {
				...
				src: url("{{ url('fonts/MinIWA-Md-V3-Regular.woff2', [], true) }}") format('woff2');
				font-weight: 400;
				font-style: normal;
				font-display: swap;
			}
			@font-face {
				...
				src: url("{{ url('fonts/MinIWA-Bd-V3-Regular.woff2', [], true) }}") format('woff2');
				font-weight: 400;
				font-style: normal;
				font-display: swap;
			}
			@font-face {
				...
				src: url("{{ url('fonts/MinIWA-Hv-V3-Regular.woff2', [], true) }}") format('woff2');
				font-weight: 400;
				font-style: normal;
				font-display: swap;
			}
		...
		})(window,document,'script','dataLayer','GTM-MXBP9WWQ');</script>
		...
		<link href="https://fonts.googleapis.com/css2?family=Shalimar&family=Zen+Maru+Gothic:wght@500;700&display=swap" rel="stylesheet">
	...
	<div id="wrap">
		<body>
			...
			<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MXBP9WWQ"
...
<!-- 									<div class="yaar-note-box">
			...
			<script>
				...
				/* =========================
				   Movie
				========================= */
				function isMovieShowing() {
					return $("#movie").hasClass("is-show");
				}
				function stopMovieIfPlaying() {
				...
				/* =========================
				   Route
				========================= */
				function isMenuPage(routeName) {
					return routeName === "menu" || routeName === "pizza";
				}

				/* =========================
				   Weekly Modal
				========================= */
				function shouldShowWeeklyModal(data) {
					return !data;
				}
				function showWeeklyModal(delay) {
					setTimeout(function() {
				...
				$('.weekly-modal-close').on('click', function() {
					...
					if (value) {
						const item = {
							value: value,
							expiry: new Date().getTime() + 24 * 60 * 60 * 1000 // 1日後のタイムスタンプ
						};
